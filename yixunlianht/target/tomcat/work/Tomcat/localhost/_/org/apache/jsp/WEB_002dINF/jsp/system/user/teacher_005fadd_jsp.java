 ...
 * Generated at: 2018-05-19 15:07:24 UTC
...
public final class teacher_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\t\t\t\t\t\t<form action=\"teacher/saveT.do\" name=\"userForm\" id=\"userForm\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"number\" name=\"phone\" id=\"phone\"  value=\"\"  maxlength=\"32\" placeholder=\"这里输入手机号\" title=\"手机号\" style=\"width:98%;\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"name\" id=\"name\"  value=\"\"  maxlength=\"32\" placeholder=\"这里输入姓名\" title=\"姓名\" style=\"width:98%;\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td style=\"width:79px;text-align: right;padding-top: 13px;\">提成:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"number\" name=\"commission\" id=\"commission\"  value=\"\"  maxlength=\"32\" placeholder=\"提成为百分比\" title=\"提成\" style=\"width:98%;\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td style=\"width:79px;text-align: right;padding-top: 13px;\">居住地址:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"address\" id=\"address\"  value=\"\"  maxlength=\"32\" placeholder=\"输入居住地址\" title=\"居住地址\" style=\"width:98%;\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td style=\"width:79px;text-align: right;padding-top: 13px;\">工作单位:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"workunit\" id=\"workunit\"  value=\"\"  maxlength=\"32\" placeholder=\"输入工作单位\" title=\"工作单位\" style=\"width:98%;\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td style=\"width:79px;text-align: right;padding-top: 13px;\">备注:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><textarea name=\"remark\" id=\"remark\" rows=\"5\" cols=\"45\"></textarea></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar myreg=/^[1][3,4,5,6,7,8,9][0-9]{9}$/;\r\n");
      ...
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}else if($(\"#phone\").val().length != 11 ){\r\n");
      out.write("\t\t\t$(\"#phone\").tips({\r\n");
      out.write("\t\t\t\tside:3,\r\n");
      ...
      out.write("\t\t\t$(\"#phone\").focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}else if(!myreg.test(ph)){\r\n");
      out.write("\t\t\t$(\"#phone\").tips({\r\n");
      out.write("\t\t\t\tside:3,\r\n");
      out.write("\t            msg:'手机号格式不正确',\r\n");
      out.write("\t            bg:'#AE81FF',\r\n");
