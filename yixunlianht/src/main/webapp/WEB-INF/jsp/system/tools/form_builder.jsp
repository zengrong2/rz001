...
<body class="gray-bg">
											                        ...
											                        <form class="form-horizontal m-t">
											                            ...
											                            <div class="form-group draggable">
											                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">下拉框：</label>
																				...
																				<div class="selQ728971035Qsel"></div>
											                            ...
											                            <div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<div class="fileQ728971035Qfile"></div>
	...
	function getUeditorFormHtml(html,msg,isgx){
		var arryUe = html.split('<div class="ueQ728971035Que"></div>');
		if(arryUe.length == 3){
			var uejscode = "<script id=\"editor\" type=\"text/plain\" style=\"width:96%;height:200px;\"><\/script>";
			if(msg == '1'){
				if(isgx == '2'){
					ueditorHtml = arryUe[1];
					return arryUe[0] + '<div class="ueQ728971035Que"></div>' + uejscode + '<div class="ueQ728971035Que"></div>' + arryUe[2];
				}else{
					return arryUe[0] + '<div class="ueQ728971035Que"></div>' + ueditorHtml + '<div class="ueQ728971035Que"></div>' + arryUe[2];
				}
			}else{
	...
	function getSelectFormHtml(html,msg,isgx){
		var arrySe = html.split('<div class="selQ728971035Qsel"></div>');
		if(arrySe.length == 3){
			...
			if(msg == '1'){
				if(isgx == '2'){
					return arrySe[0] + '<div class="selQ728971035Qsel"></div>' + selectcode + '<div class="selQ728971035Qsel"></div>' + arrySe[2];
				}else{
					selectHtml = arrySe[1];
					return html;
				}
	...
	function getFileFormHtml(html,msg,isgx){
		var arryFile = html.split('<div class="fileQ728971035Qfile"></div>');
		if(arryFile.length == 3){
			var filecode = "<input type=\"file\" id=\"tp\" name=\"tp\" />";
			if(msg == '1'){
				if(isgx == '2'){
					fileHtml = arryFile[1];
					return arryFile[0] + '<div class="fileQ728971035Qfile"></div>' + filecode + '<div class="fileQ728971035Qfile"></div>' + arryFile[2];
				}else{
					return arryFile[0] + '<div class="fileQ728971035Qfile"></div>' + fileHtml + '<div class="fileQ728971035Qfile"></div>' + arryFile[2];
				};
			}else{
