									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>schoolProType/saveSchoolProTypeInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
													<textarea name="CONTENT" id="CONTENT" style="display: none"></textarea>
													<input type="hidden" value="${pd.school_id }" name="school_id">
													<table style="width: 100%;" id="xtable">
						
														<tr id="users">
															<td style="padding-top: 10px;">升学类别:<input
																type="text" name="c_name" id="name" value=""
																maxlength="50" placeholder="这里输入升学类别" title="升学名称"
																style="width: 350px; margin-left: 20px; margin-right: 10px;" />
												
															</td>
														</tr>
														<tr >
															<td style="padding-top: 10px;">升学专业:<input
																type="text" name="c_major" id="c_major" value=""
																maxlength="50" placeholder="这里输入升学专业" title="升学专业"
														...
														<tr >
															<td style="padding-top: 10px;">升学费用:<input
																type="text" name="c_tuition" id="c_tuition" value=""
																maxlength="50" placeholder="这里输入升学费用(单位：元)" title="升学费用"
																style="width: 240px; margin-left: 20px; margin-right: 10px;" />
															</td>
														</tr>
