...
<body>
									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>qualified/saveQ.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
													<textarea name="CONTENT" id="CONTENT" style="display: none"></textarea>
													<table style="width: 100%;" id="xtable">
														<tr id="users">
															<td style="padding-top: 10px;">
															<input type="hidden" name="qualified_id" id="qualified_id"  value="${pd.qualified_id }" />
															资质名称:
															<input type="text" name="qualified_name" id="qualified_name" value="${pd.qualified_name }" maxlength="50" placeholder="这里输入资质名称" title="资质名称"  style="width: 240px; margin-left: 20px; margin-right: 10px;" />
															</td>
														</tr>
										              <tr>
										              <td style="padding-top: 10px;">资质图：
										<input type="hidden" name="img_url" id="img_url"  value="${pd.img_url }" />
										<input type="file" onchange="choose()" style="display:none" id="imgFile"/>
										<label for="imgFile" class="btn btn-mini btn-primary" style="margin-left: 15px;">上传资质图</label>
	...
	localStorage.removeItem('pdtMinImg');
