									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>train/curriculum/addChapter.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
													<textarea name="CONTENT" id="CONTENT" style="display: none"></textarea>
														<input type="hidden" value="${pd.curriculum_id }" name="curriculum_id">
													
													<table style="width: 100%;" id="xtable">
														<tr>
														<td>
										<input type="file" onchange="toXx()" style="display:none" id="xxFile"/>
										<label for="xxFile" class="btn btn-mini btn-primary" style="margin-left: 15px;">上传课程信息</label>
										<input type="text" name="chapter_name" id="profile" value=""   style="width: 430px; margin-left: 20px;"/>
