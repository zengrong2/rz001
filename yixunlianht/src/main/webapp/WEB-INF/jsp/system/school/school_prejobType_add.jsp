									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>train/savePreJobTypeTypeInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal" 
												enctype="multipart/form-data">
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr id="users">
															<td style="padding-top: 10px;">岗前培训类型:<input
																type="text" name="w_name" id="name" value=""
																maxlength="50" placeholder="这里输入岗前培训类型" title="岗前培训类型"
