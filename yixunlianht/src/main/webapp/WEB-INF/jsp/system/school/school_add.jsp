									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>school/saveS.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr id="users">
															...
															学校名称:<input
																...
																maxlength="50" placeholder="这里输入学校名称" title="学校名称"
														...
														<tr >
															...
															<td style="padding-top: 10px;">学校电话:<input
																type="text" name="school_phone" id="school_phone" value=""
																maxlength="50" placeholder="这里输入学校电话" title="学校电话"
																style="width: 240px; margin-left: 20px; margin-right: 10px;" />
																校长:<input type="text" placeholder="这里输入学校校长"  id="principal"  name="principal"  /> 
															</td>
														...
														<tr>
														 ...
														 <td style="padding-top: 10px;">学校类型:<input
																type="text" name="stype" id="stype" value=""
																maxlength="50" placeholder="例如：财经类等" title="学校名称"
																style="width: 240px; margin-left: 20px; margin-right: 10px;" />
																类型:<input type="text" placeholder="例如:公立、私立等"  id="type"  name="type"  /> 
															</td>
														...
														<tr>
																...
																机构等级:<input type="text" placeholder="例如:本科，专科"  id="grade"  name="grade"  /> 
															    </td>
														...
														<tr>
																 ...
																 <td style="padding-top: 10px;"> 
																学校管理员: <select  name="user_id" id="user_id" data-placeholder="选择学校管理员" style="vertical-align:top;width: 120px;">
	...
	// 百度地图API功能
   	...
   	//保存
		function save() {
			...
			if ($("#is_distribution_work").val() == "") {
				$("#is_distribution_work").tips({
					side : 3,
					msg : '选择是否包分配',
					bg : '#AE81FF',
					time : 2
				});
				$("#is_distribution_work").focus();
				return false;
			}
