										...
										<td class='center' style="width: 30px;">
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.del == 1 }">
													<a class="btn btn-xs btn-danger" onclick="delSmajor('${st.teacher_id}');">
...
function delSmajor(schoolId){
	bootbox.confirm("确定要删除吗?", function(result) {
		if(result) {
			top.jzts();
			var url = "<%=basePath%>school/teacher/deleteSt.do?teacher_id="+schoolId;
...
function add(){
	 ...
	 diag.Drag=true;
	 diag.Title ="新增";
	 diag.URL = '<%=basePath%>school/teacher/goAddSt.do';
	 diag.Width = 450;
	 diag.Height = 500;
