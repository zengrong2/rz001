								...
								<form action="#" name="userForm" id="userForm" method="post">
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><span>${tdActivity.activitycategoryId }</span></td>
										</tr>
										<tr>
											<td style="width:100px;text-align: center;font-weight:bold;padding-top: 13px;">活动报名开始时间:</td>
											<td><span>${tdActivity.activitysignStarttime }</span></td>
										</tr>
										<tr>
										 ...
										 <tr>
											...
											<td><span>${tdActivity.activitystartTime }</span></td>
										</tr>
										<tr>
										...
										<tr>
											<td style="width:100px;text-align: center;font-weight:bold;padding-top: 13px;">精准客户匹配区域:</td>
											<td><span>省市区：${tdActivity.provinceCitycode }:${tdActivity.cityCitycode }:${tdActivity.areaCitycode }
											</span></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><span><img src="">${tdActivity.activityCoverimgurl }
											</span></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><span>${tdActivity.activitymusicId }
											</span></td>
										</tr>
										<tr>
