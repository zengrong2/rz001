								...
								<tr>
									...
									<th class="center" style="width:60px;">编号</th>
									   ...
									   <th class='center'>主办方</th>
									    ...
									    <th class='center'>收费项目</th>
									   <!--  <th class='center'>提成项目</th> -->
									    <th class='center'>报名开始时间</th>
										<th class='center'>报名结束时间</th>
								...
								<c:when test="${not empty listActivity}">
									<c:forEach items="${listActivity}" var="ts" varStatus="vs">
										<tr>
											...
											<td class='center'>${ts.activity_name}</td>
										...
										<td class='center'>${ts.activitystart_time }</td>
										<td class='center'>${ts.activitystart_time }</td>
										...
										<td class='center'>${ts.activitysign_starttime}</td>
										<td class='center'>${ts.activitysign_endtime}</td>
										<td class="center" style="cursor:pointer;color:blue;" onClick="toActivityEnrollDetail('${ts.activity_id}')">活动报名详情</td>
