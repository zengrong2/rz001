									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>activityType/saveActivityTypeInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
													<textarea name="CONTENT" id="CONTENT" style="display: none"></textarea>
													
													
												 <%-- <input type="hidden" value="${pd.company_id }" name="company_id"> --%>
													
													<table style="width: 50%;height: 50%;" id="xtable">
						                               <span style="font-family: cursive;">添加活动类别</span>
														<tr id="users">
															<td style="padding-top: 0px;">
															
															<span class="badge badge-important" style="font-size:16px;height:35px;line-height:35px; position:relative; top:30px;">&nbsp;&nbsp;活动类型名称:&nbsp;&nbsp;</span>
															<input
																type="text" name="activitycategory_name" id="name" value=""
																maxlength="50" placeholder="请输入类型名称" title="活动类型名称"
													...
													<tr id="users">
															...
															<span class="badge badge-info">&nbsp;&nbsp;设置为特殊活动:&nbsp;&nbsp;</span>
															<span style="margin-left: 40px;">
															<input type="radio" name="isSpecial" id="isSpecial" value="0" checked="checked" /><span style="font-family: cursive;">否</span>
												            <input type="radio" name="isSpecial" id="isSpecial" value="1" style="margin-left:40px;" /><span style="font-family: cursive;">是</span>
												            </span>
															</td>
														</tr>
