				...
				<div class="page-content">
					<div class="row">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center" style="width:60px;">编号</th>
									    <th class='center'>活动提成项目名称</th>
									
									    <th class='center'>活动提成项目费用</th>
									  <th class='center'>活动提成项目创建时间</th>
							...
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty tdExtractprojecList}">
									<c:forEach items="${tdExtractprojecList}" var="ts" varStatus="vs">
										<tr>
										
											
											<td class="center">${vs.index+1}</td>
											<td class='center'>${ts.projectName}</td>
										
										<td class='center'>${ts.projectRate}</td>
