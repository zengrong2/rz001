							...
							<thead>
								<tr>
									...
									<th class="center" style="width:60px;">编号</th>
									    ...
									    <th class='center'>签到情况</th>
									    <th class='center'>成交情况</th>
							...
							<c:choose>
								<c:when test="${not empty tdUenrollandactivityList}">
									<c:forEach items="${tdUenrollandactivityList}" var="ts" varStatus="vs">
										...
										<td class='center'>${ts.tdUser.uNickname}</td>
										<td class='center'>
										<img alt="" src="${ts.tdUser.headUrl}" width="30px;" height="30px;">
										</td>
								        <c:if test="${ts.tdUser.uSex ==1 }">
								        <td class='center'>男</td>
								        </c:if>
								         <c:if test="${ts.tdUser.uSex ==0 }">
								        <td class='center'>女</td>
								        </c:if>
								         <c:if test="${ts.tdUser.uSex !=0&&ts.tdUser.uSex!=1 }">
								        <td class='center'>暂无</td>
								        </c:if>
										<td class='center'>${ts.tdUser.uPhone }</td>
										<td class='center'>邀约人</td>
										...
										<c:if test="${ts.paymentStatus==0 ||ts.paymentStatus==''||ts.paymentStatus==null}">
										<td class='center'>
						                <a class="label label-success arrowed" >未成交</a>						
										</td>
										</c:if>
										<c:if test="${ts.paymentStatus==1 }">
										<td class='center'>
						                <a class="label label-success arrowed" >已成交</a>						
										</td>
										</c:if>
