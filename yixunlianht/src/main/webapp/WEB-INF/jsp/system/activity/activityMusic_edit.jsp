									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>activityMusic/editActivityMusicById.do" name="menuForm" id="menuForm" method="post" class="form-horizontal" enctype="multipart/form-data">
											
											<input type="hidden" name="activitymusic_id" id="tid" value="${tdActivitymusicurl.activitymusicId}"/>
												 ...
												 <%-- <input type="hidden" value="${pd.company_id }" name="company_id"> --%>
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr id="users">
															<td style="width:140px;text-align: center;font-weight:bold;padding-top: 13px;">活动音乐名称:
															</td><td><input
																type="text" name="activitymusic_name" id="name" value="${tdActivitymusicurl.activitymusicName }"
														...
														<tr>
														<td style="width:140px;text-align: center;font-weight:bold;padding-top: 13px;">上传活动音乐：
														</td><td>	<input
												    	...
												    	<tr>
											             ...
											             <td><textarea name="remark" id="remark" rows="5" cols="45">${tdActivitymusicurl.remark }</textarea></td>
										                </tr>
