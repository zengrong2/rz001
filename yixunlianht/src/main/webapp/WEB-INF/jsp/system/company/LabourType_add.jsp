									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>company/saveLabourTypeInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal" enctype="multipart/form-data" >
													<textarea name="CONTENT" id="CONTENT" style="display: none"></textarea>
													<input type="hidden" value="028-82687920" name="phone">
													<table style="width: 100%;" id="xtable">
						
														<tr id="users">
															<td style="padding-top: 10px;">劳动就业类型:<input
																type="text" name="labour_name" id="name" value=""
																maxlength="50" placeholder="这里输入劳动就业类型" title="劳动就业类型"
																style="width: 300px; margin-left: 20px; margin-right: 10px;" />
												
															</td>
														</tr>
														<tr >
															<td style="padding-top: 10px;">类型图片:<input
																type="file" name="file" id="fileImage" value=""
																maxlength="50" placeholder="这里添加类型图片" title="类型图片"
