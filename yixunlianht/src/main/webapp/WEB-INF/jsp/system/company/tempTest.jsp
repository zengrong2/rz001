									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>company/saveLabourTypeInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr >
															<td style="padding-top: 10px;">类型图片:<input
																type="file" name="labour_image" id="phone" value=""
