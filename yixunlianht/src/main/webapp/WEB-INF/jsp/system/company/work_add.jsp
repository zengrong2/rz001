									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>work/savePositionInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
												 ...
												 <input type="hidden" value="${pd.company_id }" name="company_id">
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr id="users">
															<td style="padding-top: 10px;">职位名称:
															<input
																type="text" name="p_name" id="name" value=""
																maxlength="50" placeholder="这里输入职位名称" title="职位名称"
																style="width: 350px; margin-left: 20px; margin-right: 10px;" />
												
															</td>
														</tr>
														<tr>
															<td style="padding-top: 10px;">工作内容:<input
																type="text" name="p_content" id="p_content" value=""
																maxlength="50" placeholder="这里输入工作内容" title="工作内容"
																style="width: 240px; margin-left: 20px; margin-right: 10px;" />
															</td>
														</tr>
														<tr>
														 <td style="padding-top: 10px;">工作需求:<input
																type="text" name="p_requirement" id="p_requirement" value=""
																maxlength="50" placeholder="例如：大专以上,本科学历" title="工作需求"
																style="width: 240px; margin-left: 20px; margin-right: 10px;" />
																薪资:<input type="text" placeholder="例如:5000,8000(单位：元)"  id="p_salary"  name="p_salary"  /> 
															</td>
														</tr>
														<tr>
														<c:if test="${pd.company_id==0||pd.company_id==''||pd.company_id==null}">
															<td style="padding-top: 10px;">招聘公司名字:
														    <select  name="company_id" id="company_id" data-placeholder="选择招聘公司" style="vertical-align:top;width: 120px;">
															<option value="">招聘公司</option>
															<c:forEach items="${allCompany}" var="c">
																<option value="${c.company_id}">${c.company_name }</option>
													                  ...
													                  就业类型:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select  name="p_type" id="p_type" data-placeholder="选择就业类型" style="vertical-align:top;width: 120px;">
														...
														<td style="padding-top: 10px;">
																...
																maxlength="50" placeholder="例如：普工,经理" title=" 工作职位"
																style="width: 240px; margin-left: 20px; margin-right: 10px;" />
														</td>
														</tr>
														<tr>
