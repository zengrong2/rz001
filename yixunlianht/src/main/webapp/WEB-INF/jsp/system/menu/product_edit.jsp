			...
			<div class="main-content-inner">
				<div class="page-content">
					...
					<div class="row">
						...
						<form  action="<%=basePath%>pdtType/edit.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
							<input type="hidden" name="ptid" id="ptid" value="${pd.ptid }"/>
							<input type="hidden" name="t_state" id="t_state" value="${pd.t_state }"/>
							<input type="hidden" name="p_id" id="p_id" value="${null == pd.p_id ? id:pd.p_id}"/>
