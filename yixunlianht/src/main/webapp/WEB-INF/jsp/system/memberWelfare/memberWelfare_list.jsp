					...
					<div class="row">
							...
							<tr>
								<%-- <td>
									...
									<span class="input-icon">
										<input class="nav-search-input" autocomplete="off" id="nav-search-input" type="text" name="keywords" value="${pd.keywords }" placeholder="这里输入福利名称" />
					   ...
					   --%>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center" style="width:60px;">编号</th>
									 <th class='center'>福利标题</th>
									 <th class='center'>领取条件</th>
									 <th class='center'>福利详情</th>
							...
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty listMembershipwelfare}">
									<c:forEach items="${listMembershipwelfare}" var="ts" varStatus="vs">
										<tr>
										...
										<td class='center'>${ts.welfare_title}</td>
										<td class='center'>${ts.welfare_condition}</td>
										<td class='center'>${ts.welfare_context}</td>
