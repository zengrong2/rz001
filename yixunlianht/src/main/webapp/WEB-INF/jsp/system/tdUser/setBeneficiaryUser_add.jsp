...
<body>
									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin" >
												<form  action="<%=basePath%>setBeneficiaryUser/setBeneficiaryInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
												 ...
												 <%-- <input type="hidden" value="${pd.company_id }" name="company_id"> --%>
													...
													<table style="width: 100%;" id="xtable" >
														...
														<tr id="users">
															<td style="padding-top: 10px;">收益人&nbsp;&nbsp;&nbsp;&nbsp;姓名:
															<input readonly="readonly"
																type="text" name="beneficiaryUserName" id="beneficiaryUserName" value=""
														...
														<tr>
															<td style="padding-top: 10px;">收益人会员号:
															<!-- <input
																type="text" name="beneficiaryUserName" id="beneficiaryUserName" value=""
																maxlength="50" placeholder="请输入收益人姓名" title="收益人姓名"
																style="width: 200px; margin-left: 20px; margin-right: 10px;" /> -->
												  <input style="width:30%;margin-left: 20px; margin-right: 10px;" type="text" name="beneficiaryUserMember" id="beneficiaryUserMember"  value="${pd.beneficiaryUserMember }"  maxlength="32" placeholder="请输入收益人会员号" title="收益人会员号"  />
												 <span class="glyphicon glyphicon-zoom-in" style="color: rgb(255, 140, 60);" aria-hidden="true" id="findBeneficiaryUserName">点击查询收益人姓名</span>
														...
														<tr>
															<td style="padding-top: 10px;">归属人&nbsp;&nbsp;&nbsp;&nbsp;姓名:
															<input readonly="readonly"
																type="text" name="memberUserName" id="memberUserName" value=""
													    ...
													    <tr>
															<td style="padding-top: 10px;">归属人会员号:
															<!-- <input
																type="text" name="memberUserName" id="memberUserName" value=""
																maxlength="50" placeholder="请输入归属人姓名" title="归属人姓名"
																style="width: 200px; margin-left: 20px; margin-right: 10px;" /> -->
												 <input style="width:30%;margin-left: 20px; margin-right: 10px;" type="text" name="memberUserMember" id="memberUserMember"  value="${pd.memberUserMember }"  maxlength="32" placeholder="请输入归属人会员号" title="归属人会员号"  />
	...
	$("#findBeneficiaryUserName").click(function() {
	...
	<!--归属人姓名-->
	$("#findMemberUserName").click(function() {
