				...
				<div class="page-content">
					<div class="row">
						...
						<span style="width:120px;font-weight: bold;">
							...
							${tdUserCount.diamondsCustomerManagerCount }</span>
							...
							<tr>
								<td>
									...
									<span class="input-icon">
										<input class="nav-search-input" autocomplete="off" id="nav-search-input" type="text" name="keywords" value="${pd.keywords }" placeholder="请输入用户姓名" style="width:120px;"/>
...
<!-- 								<td style="vertical-align:top;padding-left:2px;"><a class="btn btn-light btn-xs" onclick="searchs();"  title="检索"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></a></td>
 -->								<td>
									<div class="nav-search">	
									<span class="input-icon">
										<input class="nav-search-input" autocomplete="off" id="nav-search-input" type="text" name="memberid" value="${pd.memberid }"  placeholder="请输入会员号" style="width:120px;" />										
										<i class="ace-icon fa fa-search nav-search-icon"></i>						
									</span>
									</div>
...
<!-- 								<td style="vertical-align:top;padding-left:2px;"><a class="btn btn-light btn-xs" onclick="searchs();"  title="检索"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></a></td>
 -->					  <td>
									<div class="nav-search">	
									<span class="input-icon">
										<input class="nav-search-input" autocomplete="off" id="nav-search-input" type="text" name="userRefereeNameNum" value="${pd.userRefereeNameNum }"   placeholder="请输入归属人会员号" />										
										<i class="ace-icon fa fa-search nav-search-icon"></i>						
									</span>
									</div>
...
<!-- 								<td style="vertical-align:top;padding-left:2px;"><a class="btn btn-light btn-xs" onclick="searchs();"  title="检索"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></a></td>
 -->					  <td>
									...
									<span class="input-icon">
										<select class="chosen-select form-control"   id="nav-search-input" name="USER_IDs" id="w_id" data-placeholder="运营中心" style="vertical-align:top;width: 150px;">
					...
					<td>
									...
									<span class="input-icon">
										<select class="chosen-select form-control"   id="nav-search-input" name="UType_IDs" id="UType_IDs" data-placeholder="选择会员等级" style="vertical-align:top;width: 150px;">
								...
								<td>
									...
									<span class="input-icon">
										<select class="chosen-select form-control"   id="nav-search-input" name="cityCode_IDs" id="cityCode_IDs" data-placeholder="选择区域" style="vertical-align:top;width: 150px;">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								...
								<!--	<th class="center" style="width:60px;">编号</th>-->
									    ...
									    <th class='center' style="width:80px;">区域</th>
										<th class='center'>会员号</th>
									<!--	<th class='center'>手机号</th>-->
									    <th class='center'>级别</th>
									    <th class='center' style="width:90px;">升级时间</th>
									     <th class='center'>有效期</th>
									    <th class='center'>推荐人</th>
									    <th class='center'>归属人(即客户经理)</th>
									    <!--
									     <th class='center'>曾经参与</th>
									     <th class='center'>兴趣爱好</th>
									  
									     <th class='center'>个人需求</th>-->
									      <th class='center'>应用培训</th>
									      <th class='center'>状态</th>
									    <th class='center' style="width:90px;">注册时间</th>
