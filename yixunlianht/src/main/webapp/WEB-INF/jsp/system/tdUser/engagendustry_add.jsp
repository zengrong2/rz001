									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin" >
												<form  action="<%=basePath%>engageIndustry/saveEngageIndustryInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
												 ...
												 <%-- <input type="hidden" value="${pd.company_id }" name="company_id"> --%>
													...
													<table style="width: 100%;" id="xtable" >
														...
														<tr id="users">
															<td style="padding-top: 10px;">从事行业名称:
															<input
																type="text" name="egid_name" id="name" value=""
																maxlength="50" placeholder="这里输从事行业名称" title="从事行业名称"
