						...
						<div class="widget-box">
							...
							<div class="widget-body">
							 ...
							 <div class="step-content row-fluid position-relative">
								...
								<input type="hidden" name="journalismId" id="journalismId" value="${tdJournalism.journalismId }"/>
					
								<span style="font-weight:bold;">新闻标题：</span>	<input type="text" name="journalismName" id="journalismName" value="${tdJournalism.journalismName}" placeholder="请输入新闻名称" />
							     <span style="font-weight:bold;">新闻分享摘要：</span>	<input type="text" name="shareSummary" id="shareSummary" value="${tdJournalism.shareSummary }" maxlength="40" placeholder="请输入新闻分享摘要，40字之内" style="width:220px;"/>
 								<input type="hidden" name="journalism_show_img" id="journalism_show_img" value="${tdJournalism.journalismShowImg }" style="margin-left:350px;margin-top:-30px;"/> 
								
 								
 								<div class="btn btn-mini btn-primary"
							    style="margin-left: 15px;" onclick="toImgEdit();">请上传首页新闻图片
							    </div>
								...
								<table style="width:100%;" id="xtable">
									...
									<tr>
										<td id="nr" style="padding-top: 5px;">
                                             ...
                                             ${tdJournalism.journalismUrl} </script>
										</td>
									</tr>
									<tr>
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="static/js/myjs/toolNewsEdit.js"></script>	
<script type="text/javascript">
	...
	function toImgEdit() {
		 ...
		 diag.Drag=true;
		 diag.Title ="新增";
		 diag.URL = '<%=basePath%>page/system/news/newsPhoto_edit';
		 diag.Width = 800;
		 diag.Height = 900;
	...
	/* 	var strs1= new Array(); //定义一数组
		strs1=pdtMinImgs.split(","); */
			...
			/*  if(pdtMinImg!=1){
				...
				var strs= new Array(); //定义一数组
				strs=pdtMinImg.split(",");
				var img =  $("#journalism_show_img").val(strs[0]);
