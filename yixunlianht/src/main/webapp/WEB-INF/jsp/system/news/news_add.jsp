						...
						<div class="widget-box">
							...
							<div class="widget-body">
							 ...
							 <div class="step-content row-fluid position-relative">
								...
								<span style="font-weight:bold;">新闻标题：</span>	<input type="text" name="journalismName" id="journalismName" value="" placeholder="请输入新闻名称" />
							     <span style="font-weight:bold;">新闻分享摘要：</span>	<input type="text" name="shareSummary" id="shareSummary" value="" maxlength="40" placeholder="请输入新闻分享摘要，40字之内" style="width:220px;"/>
								<input type="hidden" name="journalism_show_img" id="journalism_show_img" value="" style="margin-left:350px;margin-top:-30px;"/> 
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="static/js/myjs/toolNew.js"></script>	
