									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
													<input hidden="hidden" type="text" name="lbt_id" id="lbt_id" value="${pd.lbt_id }" maxlength="50" placeholder="网页" title="网页"/>
													
													<table style="width: 100%;" id="xtable">
													<tr>
															<td style="padding-top: 10px;">轮播图:<input
																type="hidden" name="lbt_url" id="lbt_url"  value=""
																 maxlength="150"
																style="width: 200px; margin-left: 20px;" />
																<div class="btn btn-mini btn-primary"
																	style="margin-left: 15px;" onclick="toImgEdit();">上传轮播图</div>
															</td>
														</tr>
														<tr id="buzhidao">
    ...
    img ='${pd.lbt_url }';
   	...
   	//保存
		function save() {
			...
			console.log($("#lbt_url").val())
			$.ajax({
				url:'<%=basePath%>lubo/edit',
				type : 'POST',
				data : {
					lbt_id:lbt_id,
					lbt_url:pdtMinImg,
				...
				success : function() {
					 alert('修改成功')
					 window.location.href="<%=basePath%>lubo/toEdit";
					/* $("#zhongxin").hide();
					$("#zhongxin2").show(); */
				},
				error : function() {
