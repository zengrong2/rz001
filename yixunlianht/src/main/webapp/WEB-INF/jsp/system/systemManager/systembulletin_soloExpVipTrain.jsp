					...
					<div class="row">
					   ...
					   --%>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							...
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty listTdSystembulletin}">
									<c:forEach items="${listTdSystembulletin}" var="ts" varStatus="vs">
										<tr>
										...
										<td class="center" >
										<div style="cursor:pointer;color:blue;margin-left:10px;" onClick="toSystembulletinDetail('${ts.systembulletinId}')">预览</div>										
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-success" title="编辑" onclick="editT('${ts.systembulletinId}');">
