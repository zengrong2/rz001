							...
							<div class="widget-body">
							 ...
							 <div class="step-content row-fluid position-relative">
								...
								<input type="hidden" name="TYPE" id="TYPE" value="2"/>
 								...
 								<span style="font-weight:bold;">广告名称：</span>	<input type="text" name="img_name" id="img_name" value=""/>
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="static/js/myjs/toolAdvertisementAdd.js"></script>	
