						...
						<div class="widget-box">
							...
							<div class="widget-body">
							 ...
							 <div class="step-content row-fluid position-relative">
								...
								<input type="hidden" name="id" id="id" value="${tdAdvertisementimage.id}"/>
 								<span style="font-weight:bold;">广告名称：</span>	<input type="text" name="img_name" id="img_name" value="${tdAdvertisementimage.imgName}"/>
<!-- 							    <span style="font-weight:bold;">首页轮播图：</span><input type="file" name="journalism_showImg" id="journalism_showImg" value="" style="margin-left:350px;margin-top:-30px;"/> 
 -->								
							  <input type="hidden" name=imgurl id="imgurl" value="${tdAdvertisementimage.imgUrl}" /> 
 
								<div class="btn btn-mini btn-primary"
							    style="margin-left: 15px;" onclick="toImgEdit();">上传广告图
							    </div> 
									...
									<tr>
										<td id="nr" style="padding-top: 5px;">
											 <script id="editor" type="text/plain" style="width:96%;height:259px;">
                                               ${tdAdvertisementimage.advertisementDetailsurl}
                                             </script>
										</td>
									</tr>
									<tr>
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="static/js/myjs/toolAdvertisementEdit.js"></script>	
