						...
						<div class="widget-box">
							...
							<div class="widget-body">
							 ...
							 <div class="step-content row-fluid position-relative">
								...
								<input type="hidden" name="system_help_id" id="system_help_id" value="${tdSystemHelp.systemHelpId }"/>
								...
								<table style="width:100%;" id="xtable">
									...
									<tr>
										<td id="nr" style="padding-top: 5px;">
                                             ...
                                             ${tdSystemHelp.systemHelpContext} </script>
										</td>
									</tr>
									<tr>
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="static/js/myjs/toolSystemHelpEdit.js"></script>	
