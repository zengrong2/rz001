									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>feedbackadvice/saveSysUserReplyFeedbackadviceInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
												 ...
												 <%-- <input type="hidden" value="${pd.company_id }" name="company_id"> --%>
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr id="users">
															<td style="padding-top: 10px;"><span style="font-weight: bold;">管理员采纳反馈建议并回复内容:</span>
															<!-- <input
																type="text" name="activitycategory_name" id="name" value=""
																maxlength="50" placeholder="这里输入类型名称" title="活动类型名称"
																style="width: 350px; margin-left: 20px; margin-right: 10px;" />
												 -->
												 <textarea rows="10px" cols="65px" name="reply_context">回复内容：
									             </textarea>
															</td>
														</tr>
