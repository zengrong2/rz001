									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
												<form  action="<%=basePath%>taxrevenue/saveTaxrevenueInfo.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
												 ...
												 <%-- <input type="hidden" value="${pd.company_id }" name="company_id"> --%>
													...
													<table style="width: 100%;" id="xtable">
														...
														<tr id="users">
															<td style="padding-top: 10px;">系统个税+手续费(百分比)
															<input
																type="text" name="taxrevenue_rate" id="taxrevenue_rate" value=""
																maxlength="50" placeholder="请输入系统个税+手续费(百分比)" title="系统个税+手续费(百分比)"
