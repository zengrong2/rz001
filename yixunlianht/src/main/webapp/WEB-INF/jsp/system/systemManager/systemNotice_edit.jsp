						...
						<div class="widget-box">
							...
							<div class="widget-body">
							 ...
							 <div class="step-content row-fluid position-relative">
								...
								<input type="hidden" name="noticeId" id="noticeId" value="${tdSystembulletinNotice.noticeId }"/>
<%-- 								<span style="font-weight:bold;">系统帮助类型：</span>	<input type="text" name="system_help_type" id="system_help_type" value="${tdSystemHelp.systemHelpType }"/>
								...
								<table style="width:100%;" id="xtable">
									...
									<tr>
										<td id="nr" style="padding-top: 5px;">
                                             ...
                                             ${tdSystembulletinNotice.noticeContext} </script>
										</td>
									</tr>
									<tr>
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="static/js/myjs/toolSystemNoticeEdit.js"></script>	
