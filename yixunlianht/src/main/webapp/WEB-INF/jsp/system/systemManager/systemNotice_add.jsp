...
<!-- 								<span style="font-weight:bold;">系统帮助类型：</span>	<input type="text" name="system_help_type" id="system_help_type" value=""/>
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="static/js/myjs/toolSystemNoticeAdd.js"></script>	
