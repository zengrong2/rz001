					...
					<div class="col-xs-12">
						<form action="#" name="form1" id="form1"  method="post">
							...
							<table id="table_report" class="table  table-hover" style="border-collapse: collapse;border:0px;" >
										...
										<tr>
											<td colspan="2" style="width:140px;text-align: center;font-weight:bold;padding-top: 13px;">付款金额￥${tdBackgroundTransferRecordinput.backgroundTransferRecordMoney }</td>
											
										</tr>
							   <c:if test="${tdBackgroundTransferRecordinput.paymentStatus ==1}">
										<tr>
