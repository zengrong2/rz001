...
public class PicturesController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/goAddPhoto")
	public ModelAndView goAddPhoto() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("pdt/product/userphoto_edit");
		mv.addObject("pd", pd);
		return mv;
	}
	/**
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/goShopPhoto")
	public ModelAndView goShopPhoto() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("pdt/shop/shop_photo_edit");
		mv.addObject("pd", pd);
		return mv;
	}
	/**
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/goXhItemPhoto")
	public ModelAndView goXhItemPhoto() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("xhItem/xh_item_img_edit");
		mv.addObject("pd", pd);
		return mv;
	}
