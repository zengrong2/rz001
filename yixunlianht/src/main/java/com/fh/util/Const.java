...
/**
 * 项目名称：
 * @author:fh qq728971035[庸人修行录]
 * 修改日期：2015/11/2
*/
public class Const {
	public static final String SESSION_SECURITY_CODE = "sessionSecCode";	//验证码
	public static final String SESSION_USER = "sessionUser";				//session用的用户
	public static final String SESSION_APP_USER = "sessionAppUser";				//sessionAppUser用户
	...
	public static final String FILEPATHFILEOAH = "C:\\";	//文件上传路径(oa管理)
