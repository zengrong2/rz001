...
public class UserService implements UserManager{
	...
	public User getUserById(String applicant_id) throws Exception {
		// TODO Auto-generated method stub
		return (User)dao.findForObject("UserMapper.getUserByAid",applicant_id);
	}
	/**修改用户金额
	 * @param pd
	 * @throws Exception
	...
	@SuppressWarnings("unchecked")
	public List<User> listUserByRoldId(PageData pd) throws Exception {
		return (List<User>) dao.findForList("UserMapper.listUserByRoldId", pd);
	}

	@Override
	public void editSchoolId(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		dao.update("UserMapper.editSchoolId", pd);
	}

	@Override
	public PageData getSysUserCityCode(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (PageData)dao.findForObject("UserMapper.getSysUserCityCode", pd);
	}
