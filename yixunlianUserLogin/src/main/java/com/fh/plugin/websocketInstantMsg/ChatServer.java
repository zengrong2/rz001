...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq728971035")){
			this.userjoin(message.replaceFirst("FHadminqq728971035", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqq728971035")){
			this.userLeave(conn);
