	...
	//这个注入的是通用mapper使用的service
		...
		*/		ModelAndView mv = this.getModelAndView();
			...
			public ModelAndView editASponsorDisExtById() throws Exception{
				...
				tdActivitySponsorDistributeExtract.setActivitySponsorDistributeExtractId(pd.getString("activitySponsorDistributeExtractId"));
				/*String activitySponsorDistributeExtractType = pd.getString("activitySponsorDistributeExtractType");
				Integer activitySponsorDistributeExtractTypes = Integer.parseInt(activitySponsorDistributeExtractType);
				tdActivitySponsorDistributeExtract.setActivitySponsorDistributeExtractType(activitySponsorDistributeExtractTypes);*/
				...
				service.updateSelective(tdActivitySponsorDistributeExtract);		
