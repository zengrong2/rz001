...
public class ToolController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/uediter")
	public ModelAndView uediter() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("utils/uediter");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	@RequestMapping(value="/printPageMin")
	public ModelAndView printPageMin() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/tools/printPage3");
		mv.addObject("pd", pd);
		return mv;
	}
}
