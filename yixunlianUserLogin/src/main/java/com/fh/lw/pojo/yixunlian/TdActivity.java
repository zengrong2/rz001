...
public class TdActivity extends BasePojo{
	...
	@Transient
	private Integer royaltyRatioTemp;
...
private Integer activityChargestatus;
    ...
    public Integer getRoyaltyRatioTemp() {
		return royaltyRatioTemp;
	}

	public void setRoyaltyRatioTemp(Integer royaltyRatioTemp) {
		this.royaltyRatioTemp = royaltyRatioTemp;
	}
