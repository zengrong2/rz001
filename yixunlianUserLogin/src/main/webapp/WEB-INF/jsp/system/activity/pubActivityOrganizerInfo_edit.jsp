	...
	<div class="main-content">
		<div class="main-content-inner">
		   ...
		   <div id="zhongxin">
								...
								<input type="hidden" name="activityId" id="activityId" value="${tdActivity.activityId }"/>
			...
			<table style="width:100%;" id="xtable"  class="table table-striped table-bordered table-hover" >
						    ...
						    <td>	 
						    <input style="width:50%;" type="text" name="activityName" id="activityName"  value="${tdActivity.activityName }"  maxlength="32" placeholder="请输入活动名称" title="活动名称"  />
							</td>
							 ...
							 <td>
							   ...
							   <select  name="activitycategoryId" id="activitycategoryId" data-placeholder="选择活动类别" style="vertical-align:top;width: 200px;line-height: 40px;">
														...
														<c:forEach items="${listActivitycategory}" var="u">														
 																<option value="${u.activitycategoryId}" <c:if test="${tdActivity.activitycategoryId==u.activitycategoryId }">selected</c:if> >${u.activitycategoryName }</option>
 														</c:forEach>	
							  </select>
<!-- 						       <input style="width:50%;" type="text" name="activitycategoryId" id="activitycategoryId"  value=""  maxlength="32" placeholder="请选择活动类别" title="活动类别"  />
 -->						       </td>
						   ...
						   <tr>
							...
							<td>
							<span>开始：</span> <input style="width:30%;" type="text" value="${tdActivity.activitystartTime }" class="datetimepicker" name="activityStartTime" id="activityStartTime"  placeholder="请输入活动开始时间" title="活动开始时间" />
                            <span>结束：</span> <input style="width:30%;" type="text" value="${tdActivity.activityendTime }" class="datetimepicker" name="activityEndTime" id="activityEndTime"  placeholder="请输入活动结束时间" title="活动结束时间" />
<!--  							
 ...
 --> 						       </td>
						 ...
						 <!--   <tr>
							...
							<td>
							 <span>开始：</span>  <input style="width:30%;" type="text" value="${tdActivity.activitysignStarttime }" class="datetimepicker" name="avtivitySignUpStartTime" id="avtivitySignUpStartTime"  placeholder="请输入报名开始时间" title="报名开始时间" />
							 <span>结束：</span>   <input style="width:30%;" type="text" value="${tdActivity.activitysignEndtime }" class="datetimepicker" name="avtivitySignUpEndTime" id="avtivitySignUpEndTime"  placeholder="请输入报名结束时间" title="报名结束时间" />
						...
						<!--  <tr>
 						 ...
 						 <input style="width:50%;" type="datetime-local" name="avtivitySignUpEndTime" id="avtivitySignUpEndTime"  value=""  maxlength="32"  title="报名结束时间"  />
							 ...
							 <span class="inputStyle">&nbsp;&nbsp;    活&nbsp;动&nbsp;&nbsp;人&nbsp;数：</span>
							  ...
							  <td>
							  <input style="width:50%;" type="number" name="activitySignUpPersonNumber" id="activitySignUpPersonNumber"  value="${tdActivity.activityCountpersons }"  maxlength="32" placeholder="请输入活动报名人数" title="活动报名人数"  />
						       </td>
					</tr>
					<tr>
					  <td style="width:140px;text-align: center;font-weight:bold;padding-top: 13px;">						   
					 ...
					 <c:if test="${tdActivity.activityChargestatus==0 }">
					  ...
					  <c:if test="${tdActivity.activityChargestatus==1 }">
					 
					        <input style="width:19%;" type="radio" name="activityCostType" id="activityCostType1"   value="1"  checked="checked" maxlength="32"  title="费用"  />收费
						     <input style="width:19%;" type="radio" name="activityCostType" id="activityCostType2"   value=""   maxlength="32"  title="费用"  />免费
...
<!-- 						       <span style="color:red;width:20px;height:20px;font-weight:bolder; border-radius: 10px;background-color: gray;"id="addCostProject">&nbsp;&nbsp;+&nbsp;&nbsp;</span>
 -->						       <button style="border-radius: 20px;font-weight:bolder;" type="button" class="btn btn-primary btn-sm btn-warning" id="addCostProject">+</button>
					 ...
					 <c:if test="${tdActivity.activityChargestatus==1 }">
						    <tr style="visibility:visible;" id="showCostProjectInput">
						   		<td style="width:140px;text-align: center;font-weight:bold;padding-top: 13px;">
						   
							 <span class="inputStyle">&nbsp;&nbsp;&nbsp;收&nbsp;费&nbsp;&nbsp;项&nbsp;目：</span>
							 </td>
							 <td>
							 <input style="width:30%;" type="text" name="costProjectmName" id="returnCostProjectmName0"  value="${activityprojectandacsigns[0].activityChargeItemName }"  maxlength="32" placeholder="请输入收费项目" title="收费项目"  />
						    <!--    </td>						
						   		<td style="width:140px;text-align: center;font-weight:bold;padding-top: 13px;"> -->
							 <input style="width:30%;" type="number" name="costProjectMoney" id="returnCostProjectMoney0"  value="${activityprojectandacsigns[0].activityChargeItemMoney }"  maxlength="32" placeholder="请输入收费金额" title="收费金额"  />
<!-- 						       <span style="color:red;width:20px;height:20px;font-weight:bolder; border-radius: 10px;background-color: gray;"id="addCostProject">&nbsp;&nbsp;+&nbsp;&nbsp;</span>
 -->						       <button style="border-radius: 20px;font-weight:bolder;" type="button" class="btn btn-primary btn-sm btn-warning" id="addCostProject">+</button>
						       </td>
						    </tr>
						    ...
						    <!-- 生成收费项目 -->
						     <table style="width:100%;" id="xtable"  class="createCostProjectInput table table-striped table-bordered table-hover" >
						    	<c:if test="${tdActivity.activityChargestatus==1 }">
						    	    <input type="hidden" name="returnCostProjectCount" id="returnCostProjectCount" value="${activityprojectandacsigns.size() }">
									<c:forEach items="${activityprojectandacsigns}" var="costProject" begin="1"  varStatus="countCostProject">
									<tr id="returnCostProject${countCostProject.index }" class="removeAllReturnCostProject">
									<td style="width:170px;text-align:center;font-weight:bold;padding-top:13px;font-size:18px;font-family:cursive">
									<span>&nbsp;收&nbsp;费&nbsp;项&nbsp;目&nbsp;:</span></td>
									<td>
									<input type="text" name="costProjectmName" style="width:30%;" value="${costProject.activityChargeItemName }"  maxlength="32"placeholder="请输入收费项目名称" title="项目费用名称" id="returnCostProjectmName${countCostProject.index }" class="returnInputProjectName"/>
									<input type="number" name="costProjectmMoney" maxlength="32"  style="width:30%;" value="${costProject.activityChargeItemMoney }" placeholder="请输入收费项目费用" title="项目费用" id="returnCostProjectMoney${countCostProject.index }" class="returnInputProjectMoney"/>
									<button class="btn btn-primary btn-sm btn-danger" type="button" id="removeCostProject" onClick="removeReturnCostProject('${countCostProject.index }')" style="border-radius:20px;font-weight:bolder">-</button>
									</td>
									</tr>
									</c:forEach>
								</c:if>
...
　                                                                                        <c:if test="${tdAddressPP!=null }">   　
                                <option value="${tdActivity.precisionDemandProvinceId }">${tdAddressPP.cityname }</option>
                                     </c:if>
                                     <c:if test="${tdAddressPP==null&&tdActivity.precisionDemandProvinceId==000000 }">   　
                                <option value="${tdActivity.precisionDemandProvinceId }">全部</option>
                                     </c:if>
                                     <c:if test="${tdAddressPP==null&&tdActivity.precisionDemandProvinceId!=000000 }">   　
                                <option value="${tdActivity.precisionDemandProvinceId }">请选择省</option>
                                     </c:if>
　　                                                                        </select>
　　                                                                       <!--   <span style="margin-left:-30px;">市:</span> -->
                               <select id="cid" name="clientMatchAreaCitycode2"   data-placeholder="请选择市" >
　　                                                                                           <%--   <option value="${tdActivity.precisionDemandCityId }">${tdAddressPC.cityname }</option> --%>
　　                                                                                   <c:if test="${tdAddressPC!=null }">   　
                                <option value="${tdActivity.precisionDemandCityId }">${tdAddressPC.cityname }</option>
                                     </c:if>
                                     <c:if test="${tdAddressPC==null&&tdActivity.precisionDemandCityId==000000 }">   　
                                <option value="${tdActivity.precisionDemandCityId }">全部</option>
                                     </c:if>
                                     <c:if test="${tdAddressPC==null&&tdActivity.precisionDemandCityId!=000000 }">   　
                                <option value="${tdActivity.precisionDemandCityId }">请选择市</option>
                                     </c:if>
                               </select>
　　　                                                             <!--    <span style="margin-left:-30px;">区县:</span> -->
                                <select id="did" name="clientMatchAreaCitycode3"  data-placeholder="请选择区县">
                                <%-- 
　                                                                                           　<option value="${tdActivity.precisionDemandAreaId }">${tdAddressPA.cityname }</option>
　　                                                                       --%>
                                    <c:if test="${tdAddressPA!=null }">   　
                                <option value="${tdActivity.precisionDemandAreaId }">${tdAddressPA.cityname }</option>
                                     </c:if>
                                     <c:if test="${tdAddressPA==null&&tdActivity.precisionDemandAreaId==000000 }">   　
                                <option value="${tdActivity.precisionDemandAreaId }">全部</option>
                                     </c:if>
                                     <c:if test="${tdAddressPA==null&&tdActivity.precisionDemandAreaId!=000000 }">   　
                                <option value="${tdActivity.precisionDemandAreaId }">请选择区县</option>
                                     </c:if>
                                  </select>
							...
							<td>
							  <select  name="activitymusicId" id="activitymusicId" data-placeholder="选择活动音乐类别" style="vertical-align:top;width: 200px;">
														...
														<c:forEach items="${listActivitymusicurl}" var="u">
														 <option value="${u.activitymusicId}" <c:if test="${tdActivity.activitymusicId==u.activitymusicId }">selected</c:if> >${u.activitymusicName }</option> 
...
<!-- 						    <input style="width:50%;" type="text" name="journalismName" id="journalismName"  value=""  maxlength="32" placeholder="请输入活动名称" title="活动名称"  />
 -->					        <span id="showCoverIng">
                                <c:if test="${tdActivity.activityCoverimgurl!=null&&tdActivity.activityCoverimgurl!='/' }">
                            
                                <img alt="封面图" src="http://fb.yxl58.com${tdActivity.activityCoverimgurl }" width="200px;" id="showCoverImgage">
                                </c:if>
                                </span>    
                                <div class="btn btn-mini btn-primary"
							    style="margin-left:600px;margin-top:-80px;" onclick="toImgEdit();">请上传活动封面图
							    <input type="hidden" name="activity_cover_img" id="activity_cover_img" value="${tdActivity.activityCoverimgurl}" />
							    </div>   
                        </td>
						  </tr>
						  <tr>
...
<!--                              <textarea rows="5" cols="25" name="shareSummary" id="shareSummary"  value=""  maxlength="64" placeholder="请输入分享摘要" title="分享摘要" ></textarea>
 -->                           <textarea  class="weui_textarea" onkeyup="wordStatic(this);" maxlength="60" id="shareSummary" placeholder="请输入分享摘要(60字之内)" title="分享摘要"  rows="2" cols="60" >${tdActivity.shareAbstract }</textarea>
                           
                            <span class="weui_textarea_counter"><span id="num">${tdActivity.shareAbstract.length() }</span>/60</span>
                             </td>
						    </tr>
						     <!-- dddd -->
						    <tr>
							 ...
							 <span class="inputStyle">设置邀约提成：</span>
						       ...
						       <c:if test="${tdActivity.activityIsextract ==1}">
							   <input style="width:19%;" type="radio" name="isInvitationActivityRoyalty" id="isInvitationActivityRoyalty1"  value="1" checked="checked" maxlength="32"  title="是"  />是&nbsp;&nbsp;&nbsp;&nbsp;
						       <input style="width:19%;" type="radio" name="isInvitationActivityRoyalty" id="isInvitationActivityRoyalty2"  value=""  maxlength="32"  title="否"  />否&nbsp;
						       </c:if>
						      <span class="invitationActivityRoyalty">
						      <c:if test="${tdActivity.activityIsextract ==1}">
						      <span id="isSetInvitationExtract" style="margin-left:30px;">
						      <span>提&nbsp;成&nbsp;比&nbsp;例&nbsp;</span><input type="number" name="invitationActivityRoyaltyRate" id="invitationActivityRoyaltyRate" maxlength="32" value="${tdActivity.royaltyRatio}"
						      placeholder="请输入提成" title="提成比列" style="width:180px;" ><span>%</span>
						      </span>
						      </c:if>
						      </span>
						       </td>
						...
						<td style="width:65px;text-align: center;font-weight:bold;padding-top: 13px;">
						 ...
						 <span class="inputStyle" >活&nbsp;动&nbsp;&nbsp;类&nbsp;型：</span>
						    ...
						    <!-- 线下 -->
						      <c:if test="${tdActivity.activityType==1 }">
						      <input style="width:19%;" type="radio" name="activityOnlineStatus" id="activityOnlineStatus1"  value=""   maxlength="32"  title="线上"  />线上
						      <input style="width:19%;" type="radio" name="activityOnlineStatus" id="activityOnlineStatus2"  value="2" checked="checked"  maxlength="32"  title="线下"  />线下
						     </c:if>
						        <!-- 线上显示 -->
						   ...
						   <!--  <table style="width:100%;" id="xtable"   class="invitationActivityRoyalty table table-striped table-bordered table-hover">
						     ...
						     <table style="width:100%;" id="xtable"  class="selectOnlineStatus table table-striped table-bordered table-hover">
						      <c:if test="${tdActivity.activityType==1 }">
						     <tr id="isSetOnlineAddress">
						     <td>
						     <span style="width:140px;text-align:center;font-weight:bold;padding-top:13px;margin-left:160px;">&nbsp;活&nbsp;动&nbsp;区&nbsp;域：</span>
						     <br/>
						     <select id="pid3" name="activityAreaCitycode1" data-placeholder="请选择省">
　                                                                                        <c:if test="${tdAddressP!=null }">   　
                                <option value="${tdActivity.provinceCitycode }">${tdAddressP.cityname }</option>
                                     </c:if>
...
　　                                                                        </select>
　　                                                                       <!--   <span style="margin-left:-30px;">市:</span> -->
                               <select id="cid3" name="activityAreaCitycode2"   data-placeholder="请选择市" >
　　                                                                                           <%--   <option value="${tdActivity.precisionDemandCityId }">${tdAddressPC.cityname }</option> --%>
　　                                                                                   <c:if test="${tdAddressC!=null }">   　
                                <option value="${tdActivity.cityCitycode }">${tdAddressC.cityname }</option>
                                     </c:if>
...
　　　                                                             <!--    <span style="margin-left:-30px;">区县:</span> -->
                                <select id="did3" name="activityAreaCitycode3"  data-placeholder="请选择区县">
                                <%-- 
　                                                                                           　<option value="${tdActivity.precisionDemandAreaId }">${tdAddressPA.cityname }</option>
　　                                                                       --%>
                                    <c:if test="${tdAddressA!=null }">   　
                                <option value="${tdActivity.areaCitycode }">${tdAddressA.cityname }</option>
                                     </c:if>
						      ...
						      <td style="text-align:center;font-weight:bold;padding-top:13px;">
						     <span>&nbsp;详&nbsp;细&nbsp;地&nbsp;址</span>
						     <input type="text" name="detailedAddress" id="detailedAddress" value="${tdActivity.citycode }" maxlength="32" placeholder="请输入详细地址" title="详细地址"/>
						     </td>
						     </tr>
						     </c:if>
						     </table> 
								...
								<td><span style="font-weight: bolder;font-size: 18px;">编辑活动详情</span></td>
									...
									<tr>
										<td id="nr" style="padding-top: 5px;">
											 <script id="editor" type="text/plain" style="width:96%;height:259px;">
                                             ${tdActivity.activityDetailsurl}
                                             </script>
										</td>
									</tr>
					<table style="width:100%; id="xtable" class="table table-striped table-bordered table-hover" >
								  ...
								  <c:if test="${fn:length(fill.fillInItemName)!='2' }">
								   ...
								   <td>
									<input style="width:50%;" type="text" name="signUpOtherFillName" id="returnSignUpOtherFillName0"  value="${listNotMustFillTdActivityFillInItem[0].fillInItemName }"  maxlength="32" placeholder="请输入其他报名填写信息" 
									title="其他报名填写信息"  />
						       <button style="border-radius: 20px;font-weight:bolder;" type="button" class="btn btn-primary btn-sm btn-success" id="addSignUpOtherFillName">+</button>
						          ...
						          <input type="hidden" name="returnOtherFill" value="${listNotMustFillTdActivityFillInItem.size() }" id="countReturnOtherFill">
						          <c:forEach items="${listNotMustFillTdActivityFillInItem }" var="fill" begin="1" varStatus="count" >
						       
						          <tr id="returnNotMustFillRemove${count.index }" >
						          <td style="width:200px;text-align:center;font-weight:bold;padding-top:13px;" >
						          
						          <input type="text" style="width:50%;margin-left:-390px;" name="signUpOtherFillName" value="${fill.fillInItemName }" id="returnSignUpOtherFillName${count.index }" class="returnFillInput" maxlength="32" placeholder="请输入其他报名填写信息" title="其他报名填写信息"/>
<!-- 						          <button  style="border-radius:20px;font-weight:bolder;" class="btn btn-primary btn-sm btn-danger" id="removeSignUpOtherFillNames" onclick="removeReturnOtherFills()">-</button>
 -->						         <a  style="border-radius:20px;font-weight:bolder;"  class="btn btn-primary btn-sm btn-danger"  onclick="removeReturnOtherFills('${count.index}')" >-</a>
						          </td>				   
						          </tr> 
...
<!--引入属于此页面的js -->
<script type="text/javascript" src="static/js/myjs/toolOrganizerInfoEditActivity.js"></script>	

<script type="text/javascript">
$(top.hangge());
//删除已经添加的收费项目
function removeReturnCostProject(count) {
	$("#returnCostProject"+count).remove();
}
//删除已经添加的其他报名项目
function removeReturnOtherFills(count) {

	$("#returnNotMustFillRemove"+count).remove(); 
};
//保存
function save() {
...
function pub() {
	...
	//上传活动封面图
	if($("#activity_cover_img").val()==""||$("#activity_cover_img").val()=="/"){
...
/* $('.datetimepicker').datetimepicker({value:'2029/01/01 00:00',step:10});
 */
...
$(function(){
	...
	　　　　$("<option value='"+pid+"'>"+pname+"</option>").appendTo($("#pid3"));//添加下拉列表
	　　}
	}
	});
	//客户匹配区域，省市县
	...
	　　$("#cid3 option:gt(0)").remove();
	　　$("#did3 option:gt(0)").remove();
	...
	　　　　$("<option value='"+cid+"'>"+cname+"</option>").appendTo($("#cid3"));//添加下拉列表
	　　}
	},
	　　"json"//指定返回类型
	　　);
	...
	　　　　$("<option value='"+did+"'>"+dname+"</option>").appendTo($("#did3"));
	　　}
	}
	);
	});
...
$("#addSignUpOtherFillName").click(function () {
	...
	if($(".returnFillInput").val()==""){
		
		$(".returnFillInput").tips({
			side:3,
            msg:'请输入其他填写项',
            bg:'#AE81FF',
            time:2
        });
		$(".returnFillInput").focus();
		return false;
	}
	$(".returnFillInput").css({"margin-left":"0px"});
...
$("#activityOnlineStatus1").click(function () {
	...
	$("#activityCostType2").click(function() {
		...
		$(".removeAllReturnCostProject").remove();
		$("#returnCostProjectmName0").attr({"value":""});
		$("#returnCostProjectMoney0").attr({"value":""});
		$("#costProjectmName").attr({"value":""});
		$("#costProjectMoney").attr({"value":""});
		/* $("#costProjectmName").value()="";
		$("#costProjectMoney").value()=""; */
		for(var a=i;a>0;a--){
 ...
 */
	...
	$("#addCostProject").click(function() {
		...
		if($(".returnInputProjectName").val()==""){
			$(".returnInputProjectName").tips({
				side:3,
	            msg:'请输入活动收费项目',
	            bg:'#AE81FF',
	            time:2
	        });
			$(".returnInputProjectName").focus();
			return false;
		}
		if($(".returnInputProjectMoney").val()==""){
			$(".returnInputProjectMoney").tips({
				side:3,
	            msg:'请输入活动收费项目费用',
	            bg:'#AE81FF',
	            time:2
	        });
			$(".returnInputProjectMoney").focus();
			return false;
		}
		if($(".returnInputProjectMoney").val()<=0){
			$(".returnInputProjectMoney").tips({
				side:3,
	            msg:'请输入正确的活动收费项目费用',
	            bg:'#AE81FF',
	...
	/* 	var strs1= new Array(); //定义一数组
		strs1=pdtMinImgs.split(","); */
			...
			/*  if(pdtMinImg!=1){
				...
				$("#showCoverImgage").remove();
				var coverImgShow = $("<img>");
				coverImgShow.attr({"alt":"封面图","width":"200px","src":"http://fb.yxl58.com/"+strs[0],"id":"showCoverImgage"});
				
				$("#showCoverIng").append(coverImgShow);
				/*  }   */
			 };
		 diag.show();
	}
