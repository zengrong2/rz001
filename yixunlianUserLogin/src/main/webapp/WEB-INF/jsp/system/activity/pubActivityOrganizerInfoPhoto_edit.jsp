...
<body class="no-skin">
				...
				<div class="page-content">
					<div class="row">
						...
						<div style="width:800px;margin: 0 auto;text-align:center">
							<h1 style="text-align:center">活动封面图编辑</h1>
							<div>
								<p id="swfContainer">
						...
						<script type="text/javascript">
				            swfobject.addDomLoadEvent(function () {
								var swf = new fullAvatarEditor("plugins/photoEditor/fullAvatarEditor.swf","plugins/photoEditor/expressInstall.swf", "swfContainer", {
									    id : 'swf',
										upload_url : '<%=basePath%>plugins/photoEditor/upload.jsp?pdt_min_img=999',	//上传接口
										method : 'post',	//传递到上传接口中的查询参数的提交方式。更改该值时，请注意更改上传接口中的查询参数的接收方式
										src_upload : 1,		//是否上传原图片的选项，有以下值：0-不上传；1-上传；2-显示复选框由用户选择
										avatar_box_border_width : 0,
										avatar_sizes : '300*200|180*180|150*150',//'200*200|200*200|64*64',
										avatar_sizes_desc : '1000*1000像素|800*800像素|500*500像素'
									}, function (msg) {
										switch(msg.code)
										{
											case 1 : break;
	...
	<script type="text/javascript">
		...
		function savePhoto(value,type){
			 ...
			 localStorage.setItem("pdtMinImg",value);
			 localStorage.setItem("pdtMinImg",value);
			 alert("上传成功");
			top.Dialog.close();  
		}
