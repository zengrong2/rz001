...
<body class="no-skin">
							...
							<div class="widget-box">
								...
								<div class="widget-body">
								 <div class="widget-main">
									...
									<hr>
								  	<input type="button" value="打印预览3" onclick="openP3()"/>&nbsp;如果点不开,换个浏览器试试
								 </div><!--/widget-main-->
								</div><!--/widget-body-->
							</div>
						</div>
	...
	function openP3(){
		 window.open("<%=basePath%>/tool/printPageMin.do", "", 'left=250,top=150,width=300,height=350,toolbar=no,menubar=no,status=no,scrollbars=yes,resizable=yes');
	}
	</script>
</body>
</html> 
