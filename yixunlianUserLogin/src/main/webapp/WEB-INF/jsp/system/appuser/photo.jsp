...
<body>
											...
											<div class="step-content row-fluid position-relative">
												<div id="zhongxin">
													<div   width="450" height="450">
													 	<img v-for="x in photo" :src="aa+x"  width="400" height="400" style="margin-left: -9px; margin-top: -3px;">
													</div>	
	...
	<script type="text/javascript">
	   ...
	   var pho= localStorage.getItem("pdtphoto");
	   var photo = pho.split(",");
