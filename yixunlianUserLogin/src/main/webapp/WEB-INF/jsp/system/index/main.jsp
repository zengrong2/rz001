...
<head>
<base href="<%=basePath%>">
<%-- <meta HTTP-EQUIV="Content-Type"CONTENT="text/html; charset=gb2312"><meta http-equiv="refresh"content="0.1;url= <%=basePath%>organizerInfo/goListPubActivityOrganizerInfo.do">
 --%>
	<!-- jsp文件头和头部 -->
