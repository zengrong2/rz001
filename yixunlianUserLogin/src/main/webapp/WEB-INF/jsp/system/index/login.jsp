...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		<!-- 登录 -->
		<div id="windows1">
		<div id="loginbox" ><!-- http://ht.yxl58.com:8080/Users/Administrator/Desktop/back_yxlht/webapps/yixunlianht/plugins/ueditor -->
			<form action="" method="post" name="loginForm" id="loginForm">
				<div class="control-group normal_text">
					<h3>
						<!--  <img src="static/login/logo.png" alt="Logo" /> --> 
						<img  src="http://ht.yxl58.com:8080/Users/Administrator/Desktop/back_yxlht/webapps/yixunlianht/static/images/yixunlianLogin.jpg" height="40" width="40" style="border-radius: 20px; margin-left:10px;" alt="Logo" />
					    <span style="font-weight: bold;margin-left:10px;position: relative;top:3px;">易讯连信息化服务平台</span>
					</h3>
					<div style="margin-top:30px;">
					<div>
					<span style="margin-left:10px;top:3px;color:red;font-size:25px;">请用电脑版微信登录操作</span>
					</div>
					<div style="margin-top:15px;">
					<span style="margin-left:10px;top:3px;font-size: 18px; ">手机端发布请进入首页操作</span>
					</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="loginname" id="loginname" value="" placeholder="请输入会员号" />
						</div>
					</div>
				</div>
				<div class="control-group">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">浏览器登录网址：http://www.yxl58.com/fb</span></font>
				</div>
			</div>
		</div>
		</div>
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © FHqq728971035 2100</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq728971035fh"+loginname+",fh,"+password+"QQ728971035fh"+",fh,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
