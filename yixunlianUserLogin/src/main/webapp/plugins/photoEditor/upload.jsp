...
if ( contentType.indexOf("multipart/form-data") >= 0 )
{
	...
	while( fileItems.hasNext() )
	{
		...
		{
/* 			String virtualPath = "file/img/activity/jsp_avatar" + avatarNumber + "_" + fileName + ".jpg";
 */			
			String virtualPath = "file/img/activity/" + avatarNumber + "_" + fileName + ".jpg";
          ...
          //原始图片（默认的 file 域的名称是__source，可在插件配置参数中自定义。参数名：src_field_name）。
			if( isSourcePic )
			{
				...
				/* result.sourceUrl = virtualPath = String.format("file/img/activity/jsp_source_%s.%s", fileName, sourceExtendName);
			 */
				result.sourceUrl = virtualPath = String.format("file/img/activity/jsp_source_%s.%s", fileName, sourceExtendName);
			...
			/* String virtualPath = "file/img/activity/pdt_min_img" + avatarNumber + "_" + fileName + ".jpg";
 */String virtualPath = "file/img/activity/"+ fileName + ".jpg";
			/* avatarNumber++; */
			avatarNumber=1;
			inputStream = new BufferedInputStream(fileItem.openStream());
			outputStream = new BufferedOutputStream(new FileOutputStream("C:/"+virtualPath));
			...
			String virtualPath = "file/img/activity/xh_item_post" + avatarNumber + "_" + fileName + ".jpg";
